========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto Analisi.Dati.Fenditure
========================================================================

La creazione guidata applicazione ha creato questa applicazione Analisi.Dati.Fenditure.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione Analisi.Dati.Fenditure.


Analisi.Dati.Fenditure.vcxproj
...
Analisi.Dati.Fenditure.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Analisi.Dati.Fenditure.pch e il file dei tipi precompilato StdAfx.obj.
